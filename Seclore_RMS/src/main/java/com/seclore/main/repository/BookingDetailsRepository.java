...
public class BookingDetailsRepository implements BookingDetailsRepositoryInterface {
	...
	private static final String GETALLEXISTINGBOOKINGDETILSFORUSERID = "select *from booking_details where user_id=?";
	...
	public BookingDetails getExistingBookingDetails(int bookingId) {
		// TODO Auto-generated method stub
		try {
			BookingDetails bookingDetails = jdbcTemplate.queryForObject(GETBOOKINGDETAILSBYBOOKINGID,
	...
	public List<BookingDetails> getAllExistingBookingDetailsByUserId(int userId) {
		// TODO Auto-generated method stub
		try {
			List<BookingDetails> allBookingDetailsForUserId = jdbcTemplate.query(GETALLEXISTINGBOOKINGDETILSFORUSERID,
					new BookingDetailsRowMapper(), userId);
