...
public class BookingDetailsRepository implements BookingDetailsRepositoryInterface {
	...
	private static final String GET_BOOKING_DETAILS_BY_USER_ID = "SELECT bd.booking_id, bd.description, bd.room_id, bd.status, bd.user_id, rd.capacity, rd.audio_video, rd.white_board, rd.room_name, rd.is_available FROM booking_details bd JOIN room_details rd ON rd.room_id=bd.room_id WHERE bd.user_id=?";
